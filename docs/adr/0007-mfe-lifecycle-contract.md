...
import App from './App';
import type { MFELifecycle, MFEProps } from '@mfe-runtime/dynamic-loader';
  ...
  plugins: [
    federation({
      ...
      shared: {
        ...
        "@mfe-runtime/dynamic-loader": { singleton: true, requiredVersion: "^1" },
      },
    }),
  ],
  build: {
...
```typescript
// shell/src/shell.ts
import { mfeLoader } from "@mfe-runtime/dynamic-loader";
