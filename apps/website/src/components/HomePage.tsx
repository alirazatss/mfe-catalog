...
export default function HomePage() {
  return (
    <div style={{ textAlign: "center", padding: "2rem 0" }}>
      ...
      <p style={{ fontSize: "1.25rem", color: "#6b7280", margin: "0 0 3rem", maxWidth: "600px", marginLeft: "auto", marginRight: "auto" }}>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: "600", color: "#1f2937", margin: "0 0 1.5rem" }}>
          Features
        </h2>
        <ul style={{
          listStyle: "none",
