...
replaced by the thin vanilla-TypeScript shell in `apps/website/src/main.ts` +
`apps/website/src/shell/*`.
...
| `components/Layout.tsx`                  | `apps/mfe-header/src/Header.tsx` (rewritten)     | `chrome-mfe-header`           |
