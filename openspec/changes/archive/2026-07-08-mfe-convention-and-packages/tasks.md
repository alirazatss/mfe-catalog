...
- [x] 2.2 Initialize package.json: name `@mfe-runtine/monorepo-tools`, version `0.1.0`
...
- [x] 2.5 Add dependencies: `glob`, `@mfe-runtine/remote-config` (workspace protocol)
...
- [x] 3.2 Initialize package.json: name `@mfe-runtine/remote-config`, version `0.1.0`
