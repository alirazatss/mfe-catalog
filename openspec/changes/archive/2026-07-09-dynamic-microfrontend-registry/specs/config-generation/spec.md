...
Generates `remotes.config.json` at build time from discovered micro-frontends in the monorepo. The generated config includes environment-specific URLs and metadata extracted from package.json files.
