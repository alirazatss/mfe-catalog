...
Defines the preview deployment workflow for pull requests, including multi-shell preview builds, PR-scoped remote configs, sticky comment generation, and cleanup on PR closure.
