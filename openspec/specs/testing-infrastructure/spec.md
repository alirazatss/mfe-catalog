...
TBD - created by archiving change complete-test-infrastructure. Update Purpose after archive.
...
- **WHEN** `pnpm test` runs
- **THEN** the test output SHALL include the `@mfe-runtime/monorepo-tools#test` task
