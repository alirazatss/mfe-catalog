/**
 * JWT helper utilities for decoding and extracting user information.
 *
 * Implements shell-kit / Resilient config loaders (JWT helpers scenario).
 * See openspec/changes/shared-boilerplate-packages/specs/shell-kit/spec.md
 *
 * These helpers decode JWT payloads without verification (backend already validated).
 */
